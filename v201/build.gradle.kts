    ...
    sourceSets {
        val jvmMain by getting {
            ...
            dependencies {
                ...
                // OCPP Libs
                implementation("com.github.monta-app.library-ocpp:ocpp-core:1.0.6")
                implementation("com.github.monta-app.library-ocpp:ocpp-v201:1.0.6")
                ...
                implementation(project.dependencies.platform("io.sentry:sentry-bom:8.11.1"))

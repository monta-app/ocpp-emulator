...
internal fun ChargePointDAO.toSummary(): ChargePointSummary = transaction {
    ChargePointSummary(
        id = idValue,
        name = name,
        identity = identity,
...
internal fun ChargePointConnectorDAO.toSummary(): ChargePointConnectorSummary = transaction {
...
internal fun ChargePointTransactionDAO.toSummary(): ActiveTransactionSummary = transaction {
...
internal fun PreviousMessagesDAO.toSummary(): PreviousMessageSummary = PreviousMessageSummary(
    id = idValue,

    ...
    sourceSets {
        val jvmMain by getting {
            ...
            dependencies {
                ...
                // Websocket Client
                implementation(project.dependencies.platform("io.ktor:ktor-bom:3.1.0"))
                ...
                implementation(project.dependencies.platform("io.sentry:sentry-bom:7.22.0"))
                ...
                // SQL Database
                implementation(project.dependencies.platform("org.jetbrains.exposed:exposed-bom:0.59.0"))
